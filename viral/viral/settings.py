...
ALLOWED_HOSTS = ['192.168.43.119', '127.0.0.1', 'localhost','ViralBiyawala.pythonanywhere.com', 'viralbot.pythonanywhere.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'viralapp.context_processors.add_login_status',
            ],
        },
    },
]

WSGI_APPLICATION = 'viral.wsgi.application'
